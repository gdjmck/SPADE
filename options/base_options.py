...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--just_plot', action='store_true', help='draw model graph only, no running operations')
        ...
        parser.add_argument('--inject_num', type=int, default=-1, help='number of position to inject condition vector')
        ...
        parser.add_argument('--field_max_size', type=int, default=300,
                            help='image width or height corresponds to the size in reality')
